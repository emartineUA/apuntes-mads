...
Compensation System ([proyecto C3](https://www.martinfowler.com/bliki/C3.html), en el que conoció a Ron Jeffries. Se trató de un proyecto de gestión en Chrysler que se
...
se puede hacer una visitaa a la [página con el roadmap sobre Extreme
...
- **Simplicidad**: mantener el código y el diseño tan simple como sea
	posible incrementando la claridad, comprensibilidad, extensibilidad y
...
una reflexión a diferentes frecuencias y múltiples niveles. Los equipos
reflexionan sobre el cómo y el por qué del trabajo. Los equipos ven
los errores como una oportunidad de crecimiento.

- **Flujo**: Se deben reducir los tamaños de los trozos (de
...
objetivos es realizar un desarrollo completamente transparente, ya
...
comuniquen de forma clara y honesta. Trabajar con plazos no realistas
